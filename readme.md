...
The project supports sourcing episodes from podcast RSS feeds, so transcripts can be generated from any compatible show feed.

Primary example feed: [Vector Podcast](https://media.rss.com/vector-podcast/feed.xml)

Original archive source: [Conduit Podcast](https://relay.fm/conduit)
...
- `src/` - Application code
  ...
  - `transcriber.py` - MLX / Whisper hybrid backend
...
Vector Podcast attribution: [Vector Podcast](https://www.vectorpodcast.com/) by Dmitry Kan and Saurabh Rai.
